...
export class GameRenderer
{
  ...
  // Propriétés pour les modificateurs de paddles
  ...
  /**
   * Constructeur du GameRenderer
   * @param scene Scène Babylon.js
   * @param canvas Canvas HTML
   * @param theme Thème initial
   */
  ...
  /**
   * Applique un modificateur de taille au paddle
   * @param player Joueur concerné
   * @param multiplier Multiplicateur de taille
   */
  ...
  /**
   * Réinitialise la taille du paddle
   * @param player Joueur concerné (optionnel)
   */
   ...
   * @param positions Nouvelles positions
   */
  ...
  /**
   * Ajuste la caméra selon l'écran
   */
  ...
  /**
   * Obtient les objets de jeu
   * @returns Objets de jeu
   */
  ...
  // ==========================================
  // MÉTHODES PRIVÉES DE CRÉATION DES OBJETS
  // ==========================================

  /**
   * Crée le terrain
   * @returns Mesh du terrain
   */
  ...
  /**
   * Crée les éléments standard du terrain
   */
  ...
  /**
   * Crée les éléments italiens du terrain
   */
  ...
  /**
   * Crée des cristaux de lave
   * @param paddle Paddle concerné
   * @param player Joueur
   */
  ...
  /**
   * Anime un paddle de lave
   * @param paddle Paddle à animer
   */
  ...
  /**
   * Crée un matériau à partir de la configuration
   * @param name Nom du matériau
   * @param config Configuration du matériau
  ...
  /**
   * Supprime les éléments spécifiques aux thèmes
   */
